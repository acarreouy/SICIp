<?php
    include ("cn.php");
        $consulta="SELECT * FROM autores ORDER BY autores.Pais DESC, NombreCompleto asc";
            $resultados = mysqli_query($conexion, $consulta);
//<!-- agrege para excel 22/6/21-->
$libros=array();
...
<!--<//?php 
    //while($fila = mysqli_fetch_row($resultados)){
               ?>
                    <tr>
                        <td><//?php echo $fila[2], " ",$fila[1]?></td>
				            <td><//?php echo $fila[4]?></td>
                        <td><center><//?php echo $fila[5]?></center></td>
...
<?php foreach($libros as $libro){?>
                ...
                <tr>
<td><?php echo $libro['NombreCompleto'], " ", $libro['Apellido'];?></td>
